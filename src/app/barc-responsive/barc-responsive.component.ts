...
@Component({
  selector: 'barc-barc-responsive',
  templateUrl: './barc-responsive.component.html',
  styleUrls: ['./barc-responsive.component.scss']
})
export class BarcResponsiveComponent implements OnDestroy {
